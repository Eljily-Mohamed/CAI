...
// Composants d'icônes
export const OverviewIcon = () => <FontAwesomeIcon icon={faHome} />;
export const IntegrationIcon = () => <FontAwesomeIcon icon={faCalendarAlt} />;
export const PlansIcon = () => <FontAwesomeIcon icon={faHistory} />;
export const TransactionsIcon = () => <FontAwesomeIcon icon={faChartLine} />;
export const SettingsIcon = () => <FontAwesomeIcon icon={faCog} />;
export const ContactIcon = () => <FontAwesomeIcon icon={faEnvelope} />;

// Options de pays pour le composant Select
